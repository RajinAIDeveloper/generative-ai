      ...
      if (maskIndex !== -1 && result.masks[maskIndex]) {
        ...
        for (let y = 0; y < displayHeight; y++) {
          for (let x = 0; x < displayWidth; x++) {
            ...
            const maskX = Math.floor((x / displayWidth) * maskSize);
            const maskY = Math.floor((y / displayHeight) * maskSize);
            const maskIndex = maskY * maskSize + maskX;
            const dataIndex = (y * displayWidth + x) * 4;
