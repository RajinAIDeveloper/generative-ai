...
const ModelCard = ({ title, description, index, categoryColor }) => {
  ...
  const getModelLink = () => {
    const links = {
      ...
      'Feature Extraction': '/inference/nlp/feature-extraction',
      'Object Detection': '/inference/vision/object-detection/',
      'Image Segmentation': '/inference/vision/image-segmentation',
      'Question Answering': '/inference/nlp/question-answering',
      'Sentiment Analysis': '/inference/nlp/sentiment-analysis',
      'Image-to-Text': '/inference/vision/image-caption',
      'Text2Text Generation': '/inference/nlp/text-to-text',
      'Fill-Mask': '/inference/nlp/fill-mask',
